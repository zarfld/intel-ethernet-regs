...
/* Source YAML: i225.yaml @ 0388315; Repo: 0ecdf8a */
#pragma once
#ifdef __cplusplus
extern "C" {
#endif
...
/* access=ro */
#define I225_SYSTIML	0x0B600
/* System time register High */
/* access=ro */
#define I225_SYSTIMH	0x0B604
/* Time Increment Attributes */
/* access=rw */
#define I225_TIMINCA	0x0B608
/* TX Time Sync Control Register (0xB614) */
/* access=rw */
#define I225_TSYNCTXCTL	0x0B614
#define I225_TSYNCTXCTL_TXTT_SHIFT	0
#define I225_TSYNCTXCTL_TXTT_MASK	(((1ULL<<1)-1ULL) << I225_TSYNCTXCTL_TXTT_SHIFT)
#define I225_TSYNCTXCTL_EN_SHIFT	4
#define I225_TSYNCTXCTL_EN_MASK	(((1ULL<<1)-1ULL) << I225_TSYNCTXCTL_EN_SHIFT)
static inline unsigned long long I225_TSYNCTXCTL_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_TSYNCTXCTL_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
/* TX Timestamp Value Low */
/* access=ro */
#define I225_TXSTMPL	0x0B618
/* TX Timestamp Value High */
/* access=ro */
#define I225_TXSTMPH	0x0B61C
/* RX Time Sync Control Register (0xB620; RW) */
/* access=rw */
#define I225_TSYNCRXCTL	0x0B620
#define I225_TSYNCRXCTL_RXTT_SHIFT	0
#define I225_TSYNCRXCTL_RXTT_MASK	(((1ULL<<1)-1ULL) << I225_TSYNCRXCTL_RXTT_SHIFT)
#define I225_TSYNCRXCTL_TYPE_SHIFT	1
#define I225_TSYNCRXCTL_TYPE_MASK	(((1ULL<<3)-1ULL) << I225_TSYNCRXCTL_TYPE_SHIFT)
#define I225_TSYNCRXCTL_EN_SHIFT	4
#define I225_TSYNCRXCTL_EN_MASK	(((1ULL<<1)-1ULL) << I225_TSYNCRXCTL_EN_SHIFT)
#define I225_TSYNCRXCTL_SYSCFI_SHIFT	5
#define I225_TSYNCRXCTL_SYSCFI_MASK	(((1ULL<<1)-1ULL) << I225_TSYNCRXCTL_SYSCFI_SHIFT)
static inline unsigned long long I225_TSYNCRXCTL_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_TSYNCRXCTL_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
/* RX Timestamp Low (0xB624; RO) */
/* access=ro */
#define I225_RXSTMPL	0x0B624
/* RX Timestamp High (0xB628; RO) */
/* access=ro */
#define I225_RXSTMPH	0x0B628
...
#define I225_MDIC_DATA_SHIFT	0
#define I225_MDIC_DATA_MASK	(((1ULL<<16)-1ULL) << I225_MDIC_DATA_SHIFT)
#define I225_MDIC_REG_SHIFT	16
#define I225_MDIC_REG_MASK	(((1ULL<<5)-1ULL) << I225_MDIC_REG_SHIFT)
#define I225_MDIC_PHY_SHIFT	21
#define I225_MDIC_PHY_MASK	(((1ULL<<5)-1ULL) << I225_MDIC_PHY_SHIFT)
#define I225_MDIC_OP_SHIFT	26
#define I225_MDIC_OP_MASK	(((1ULL<<2)-1ULL) << I225_MDIC_OP_SHIFT)
#define I225_MDIC_R_SHIFT	28
#define I225_MDIC_R_MASK	(((1ULL<<1)-1ULL) << I225_MDIC_R_SHIFT)
#define I225_MDIC_I_SHIFT	29
#define I225_MDIC_I_MASK	(((1ULL<<1)-1ULL) << I225_MDIC_I_SHIFT)
#define I225_MDIC_E_SHIFT	30
#define I225_MDIC_E_MASK	(((1ULL<<1)-1ULL) << I225_MDIC_E_SHIFT)
static inline unsigned long long I225_MDIC_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_MDIC_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }

/* Block INTERRUPTS base: 0x000C0 */
/* Interrupt Cause Read */
/* access=rc/w1c */
#define I225_ICR	0x000C0
#define I225_ICR_TXDW_SHIFT	0
#define I225_ICR_TXDW_MASK	(((1ULL<<1)-1ULL) << I225_ICR_TXDW_SHIFT)
#define I225_ICR_TXQE_SHIFT	1
#define I225_ICR_TXQE_MASK	(((1ULL<<1)-1ULL) << I225_ICR_TXQE_SHIFT)
#define I225_ICR_LSC_SHIFT	2
#define I225_ICR_LSC_MASK	(((1ULL<<1)-1ULL) << I225_ICR_LSC_SHIFT)
#define I225_ICR_RXDMT0_SHIFT	4
#define I225_ICR_RXDMT0_MASK	(((1ULL<<1)-1ULL) << I225_ICR_RXDMT0_SHIFT)
#define I225_ICR_RXO_SHIFT	6
#define I225_ICR_RXO_MASK	(((1ULL<<1)-1ULL) << I225_ICR_RXO_SHIFT)
#define I225_ICR_RXT0_SHIFT	7
#define I225_ICR_RXT0_MASK	(((1ULL<<1)-1ULL) << I225_ICR_RXT0_SHIFT)
static inline unsigned long long I225_ICR_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_ICR_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
/* Interrupt Cause Set */
/* access=wo */
...
#define I225_IMS_TXDW_SHIFT	0
#define I225_IMS_TXDW_MASK	(((1ULL<<1)-1ULL) << I225_IMS_TXDW_SHIFT)
#define I225_IMS_TXQE_SHIFT	1
#define I225_IMS_TXQE_MASK	(((1ULL<<1)-1ULL) << I225_IMS_TXQE_SHIFT)
#define I225_IMS_LSC_SHIFT	2
#define I225_IMS_LSC_MASK	(((1ULL<<1)-1ULL) << I225_IMS_LSC_SHIFT)
#define I225_IMS_RXDMT0_SHIFT	4
#define I225_IMS_RXDMT0_MASK	(((1ULL<<1)-1ULL) << I225_IMS_RXDMT0_SHIFT)
#define I225_IMS_RXO_SHIFT	6
#define I225_IMS_RXO_MASK	(((1ULL<<1)-1ULL) << I225_IMS_RXO_SHIFT)
#define I225_IMS_RXT0_SHIFT	7
#define I225_IMS_RXT0_MASK	(((1ULL<<1)-1ULL) << I225_IMS_RXT0_SHIFT)
static inline unsigned long long I225_IMS_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_IMS_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
...
#define I225_EIMS_VEC0_SHIFT	0
#define I225_EIMS_VEC0_MASK	(((1ULL<<1)-1ULL) << I225_EIMS_VEC0_SHIFT)
#define I225_EIMS_VEC1_SHIFT	1
#define I225_EIMS_VEC1_MASK	(((1ULL<<1)-1ULL) << I225_EIMS_VEC1_SHIFT)
#define I225_EIMS_VEC2_SHIFT	2
#define I225_EIMS_VEC2_MASK	(((1ULL<<1)-1ULL) << I225_EIMS_VEC2_SHIFT)
#define I225_EIMS_VEC3_SHIFT	3
#define I225_EIMS_VEC3_MASK	(((1ULL<<1)-1ULL) << I225_EIMS_VEC3_SHIFT)
#define I225_EIMS_TCP_TIMER_SHIFT	30
#define I225_EIMS_TCP_TIMER_MASK	(((1ULL<<1)-1ULL) << I225_EIMS_TCP_TIMER_SHIFT)
static inline unsigned long long I225_EIMS_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_EIMS_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
...
#define I225_EICR_VEC0_SHIFT	0
#define I225_EICR_VEC0_MASK	(((1ULL<<1)-1ULL) << I225_EICR_VEC0_SHIFT)
#define I225_EICR_VEC1_SHIFT	1
#define I225_EICR_VEC1_MASK	(((1ULL<<1)-1ULL) << I225_EICR_VEC1_SHIFT)
#define I225_EICR_VEC2_SHIFT	2
#define I225_EICR_VEC2_MASK	(((1ULL<<1)-1ULL) << I225_EICR_VEC2_SHIFT)
#define I225_EICR_VEC3_SHIFT	3
#define I225_EICR_VEC3_MASK	(((1ULL<<1)-1ULL) << I225_EICR_VEC3_SHIFT)
#define I225_EICR_TCP_TIMER_SHIFT	30
#define I225_EICR_TCP_TIMER_MASK	(((1ULL<<1)-1ULL) << I225_EICR_TCP_TIMER_SHIFT)
#define I225_EICR_OTHER_SHIFT	31
#define I225_EICR_OTHER_MASK	(((1ULL<<1)-1ULL) << I225_EICR_OTHER_SHIFT)
static inline unsigned long long I225_EICR_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I225_EICR_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
