...
/* Source YAML: i217.yaml @ d97f490; Repo: d97f490 */
#pragma once
#ifdef __cplusplus
extern "C" {
#endif
...
#define I217_TSYNCRXCTL_TYPE_NONE	0U
#define I217_TSYNCRXCTL_TYPE_L4UDP_PTP_EVT	1U
#define I217_TSYNCRXCTL_TYPE_L4UDP_PTP_ALL	2U
#define I217_TSYNCRXCTL_TYPE_L2ETH_PTP_EVT	3U
#define I217_TSYNCRXCTL_TYPE_L2ETH_PTP_ALL	4U
#define I217_TSYNCRXCTL_TYPE_ALL_PKTS	7U
...
/* Block SEMAPHORES base: 0x05B50 */
/* Software-Firmware Synchronization (SW/HW semaphore for MAC register access including MDIC) */
/* access=rw */
#define I217_SWSM	0x05B50
#define I217_SWSM_SWESMBI_SHIFT	0
#define I217_SWSM_SWESMBI_MASK	(((1ULL<<1)-1ULL) << I217_SWSM_SWESMBI_SHIFT)
static inline unsigned long long I217_SWSM_GET(unsigned long long v, unsigned long long mask, unsigned shift) { return (v & mask) >> shift; }
static inline unsigned long long I217_SWSM_SET(unsigned long long v, unsigned long long mask, unsigned shift, unsigned long long val) { return (v & ~mask) | ((val << shift) & mask); }
